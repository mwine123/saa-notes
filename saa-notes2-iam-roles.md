...
users, roles, accounts and services. you can use aws identity center to centralize user
creation and that way, user credentials are generated by aws security token service.
every user login will be asuming a role instead of rotating credentials.
